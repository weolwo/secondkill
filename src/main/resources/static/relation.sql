...
INSERT INTO `goods`
VALUES (2, '华为MetaPro30 5G', '华为MetaPro30 5G版 月光银 移动联通电信5G手机 双卡双待', '/img/meta10.png',
        '华为MetaPro30 5G版 月光银 移动联通电信5G手机 双卡双待', 3212.00, 10);

-- 秒杀商品表
CREATE TABLE sedkillgoods
(
